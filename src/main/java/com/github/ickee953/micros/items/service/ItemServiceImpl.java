...
import static com.github.ickee953.micros.items.utils.Status.CREATED;
import static com.github.ickee953.micros.items.utils.Status.REPLACED;
...
public class ItemServiceImpl implements ItemService {
    ...
    public Item create(ItemDto item) {
        ...
        List<Category> categories = categoryService.getFor(item);
    ...
    public Result<Item> replace(UUID id, ItemDto newItem) {
        List<Category> categories = categoryService.getFor(newItem);
